...
<!--Titulli-->
  ...
  <p id="title" style="text-transform: uppercase;">Dream Travel</p>
  <br>
<article>
  <!--PhotoMap-->
  <section>
...
<textarea name="Hfeedback"  id="write" class="formhome" placeholder="What is your opinion about this page" rows="6" <?php if(!empty($feedbackErr)) { ?> autofocus <?php } ?>><?php echo $var = isset($_POST['Hfeedback']) ? $_POST['Hfeedback'] : ''; ?></textarea>
...
<a href="logout.php" id="destroy" style="border-radius: 20px;margin-left:17%;padding: 8px;text-decoration:none; color:white; background:grey">Logout</a>
       ...
       <?php
		...
		$numriRi2=implode(")",$vargu2);
		 ...
		 echo '<p><img src="images/telephone.png" alt="Telephone"><span class="findfooter">'.$numriRi1.'</span>
		   ...
		   ?>
       <p><a href="mailto:info@travel.com?Subject=Dream%20Travel" style="text-decoration:none;color:black;"><img src="images/email.png" alt="Email"><span class="findfooter"> info@travel.com </span></a>
          <img src="images/web.png" alt="Web"><span><u> www.travel-dream.com </u></span></p>
    </div>
 ...
 <script src="javascript/clock.js"></script>
   ...
   <div style="float:right;margin-top:-5%;margin-right:10%;">
    ...
    <nav id="llogo" >
        ...
        <a href="https://www.pinterest.com/explore/family-travel/" target="_blank"><img src="images/pinterestlogo.png" alt="P" id="imglogo"></a>
	</nav>
  <br><br><br><br>
<div style="left:-300px;">
  <?php
	if(isset($_SESSION['username']))
	{
		...
		echo "<p style='width:10%;margin-top:-1%;margin-left:2%;' class='Location'><b>User:</b> $user</p>";
	}
	?>
</div>
</footer>
