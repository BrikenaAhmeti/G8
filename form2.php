...
if(isset($_SESSION['username']))
{
  ...
  echo "<p class='Location' style='width:10%;'><b>User:</b> $user</p>";
}
?>
</div>
<p id="title" style="margin-top:-25%;margin-bottom:20%;">Contact Us</p>
<section id="bodyy" >
   <section>
    <div class="pagination">
         <table>
          <tr><td> <a href="form1.php">&laquo;</a></td>
              <td> <a href="form1.php" >Subscribe</a></td>
              <td> <a href="#" class="active">Be Part of Us</a></td>
              <td> <a href="form3.php">Suggest a place</a></td>
              <td><a href="form3.php">&raquo;</a></td></tr>
         </table>
      </div>
   </section>
    ...
    <p>
		...
		<label style="margin-left:29%;">Surname *</label><span style="font-size:12px;color:rgb(190,0,0);margin-top:-13px;margin-left:2%;"><?php echo $surnameErr;?></span><br>
            <input type="text" name="FDname" class="input" id="emri"  placeholder="Write your name" value="<?php echo $FDname; ?>"  <?php if(!empty($nameErr)) { ?> autofocus <?php } ?>>  <!--Perdorimi i autofocus,placeholder,required,(3)-->
            <input type="text" name="FDsurname" class="input" id="mbiemri"  placeholder="Your Surname" value="<?php echo $FDsurname; ?>"  <?php if(!empty($surnameErr)) { ?> autofocus <?php } ?>></p>
   ...
   <p>
		 ...
		 <label style="margin-left:33%;">Phone Number (+bbb bb bbb bbb) *</label><span style="font-size:12px;color:rgb(190,0,0);margin-bottom:-6px;margin-left:2%;"><?php echo $phoneErr;?></span><br>
              ...
              <input type="tel" name="FDphone"  class="input" value="<?php echo $FDphone; ?>"  <?php if(!empty($phoneErr)) { ?> autofocus <?php } ?>></p>

                     <!--perdorimi i pattern per te kontrolluar formatin e pranimit te dhenave per kete input faza2-->

    <p>
          <label>Birthday(month,year)</label><br>
                 <input type="month"  name="bday" value="FDbday" class="input"></p>
    <p>
    ...
    <p>
	    <label>Write a password which you will use later *</label><span style="font-size:12px;color:rgb(190,0,0);margin-bottom:-6px;margin-left:2%;"><?php echo $passwordErr;?></span><br>
               <input type="password" name="FDpassword" class="input" id="pas" placeholder="Please write 8 or more characters" value="<?php echo $FDpassword; ?>" <?php if(!empty($passwordErr)) { ?> autofocus <?php } ?> ></p> <!--Perdorimi i password inputit-->

     <p>
         <label>Country &#9662;</label><br> <!--Perdorimi i enitetit-->
               <input list="Vendet" name="FDvendi" class="input" value="<?php echo $FDvendi; ?>">
                      <datalist id="Vendet">   <!-- Perdorimi i datalist faza2-->
                         <option value="USA">
                         <option value="Kosova">
                         <option value="France">
     ...
     <p>
          <label>The level of Education</label><br>
                 <input type="radio" name="FDlevel" value="Primary" id="radio" <?php if($FDlevel != "HighSchool" and $FDlevel != "University") {?> checked <?php }?>><span>Primary School</span><br> <!--Default e shtypur do te jete shkolla fillore-->
     ...
     <p>
        ...
        <select name = "course">
        <optgroup label="Science">   <!--Ndarja e opsioneve ne seksione te caktuara te cilat jane te pashtypura-->
...
            <option value="comp" <?php if($Fcourse != "geo" and $Fcourse != "sc" and $Fcourse != "bio" and $Fcourse != "phy" and $Fcourse != "elec") {?> selected <?php } ?>>Computer Engineering</option> <!--default e paraqitur do jete Computer Engineering-->
...
        </optgroup>
	   ...
	   <label>Your exploration skills *</label><span style="font-size:12px;color:rgb(190,0,0);margin-left:1%;"><?php echo $explorerErr;?></span><br>
              <textarea name="FDexplorer" id="text" placeholder="Write here ..."  rows="10" cols="20"  <?php if(!empty($explorerErr)) { ?> autofocus <?php } ?>><?php echo $var = isset($_POST['FDexplorer']) ? $_POST['FDexplorer'] : ''; ?></textarea><br>
    <p>
	       <input type="submit" value="Send" name="submit" class="submit" style="margin-right:10%;" >  <!--mbishkrimi i metodes me te cilen do te percillen te dhenat ne server/database permes formmethod faza2-->
           <input type="reset" value="Reset" class="submit" style="margin-right:2%;"></p>
 ...
 if(isset($_SESSION['username']))
 {
   ...
   echo '<a href="participants.php" class="Location" style="text-decoration:none;">Show all participants!</a>';
 }
?>
</section>
</ section>
