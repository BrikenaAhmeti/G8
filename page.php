<?php
 class Page
 {
	 ...
	 {
		 echo '<h1 align="center" id="logo">Dream Travel</h1>
<div class="login">
...
<input type="text" placeholder="Username" id="user" name="user" style="outline:none;background-color:rgba(255, 255, 255, 0.1);border-color:grey; border-radius: 8px"><br/><br/>
<input type="password" placeholder="Password" id="pass" name="pass" style="outline:none;background-color:rgba(255, 255, 255, 0.1	);border-color:grey; border-radius:8px"><br/><br/>
