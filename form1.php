...
Author:<br><input type="text" placeholder="Write your name!" name="author" class="input"><br><br>
Message:<br><textarea placeholder="Write your comment!" name="message" class="input" style="width:80%;resize: none;" rows=6></textarea><br><br>
<button  id="comment" class="Location" style="margin-bottom:4%;">Comment</button>
</form>
<span id="result"></span>
<div id="comments">
<?php
...
<div id="show">
<a href="#" class="boton" style="text-decoration:none;margin-bottom:2%;">Show more</a>
<div style="margin-top:2%;" class="fb-like" data-href="https://web.facebook.com/upisconference/" data-layout="standard" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
</div>
</div>
</div>
